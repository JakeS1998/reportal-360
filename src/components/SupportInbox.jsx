...
export default function SupportInbox({ callerCreds }) {
  const [requests, setRequests] = useState([]), [loading, setLoading] = useState(true), [outlookConnected, setOutlookConnected] = useState(false);
