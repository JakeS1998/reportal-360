...
export default function AskReportAL({ user }) {
  ...
  return (
    <Dialog>
      <DialogTrigger asChild><button className="fixed bottom-6 right-6 z-40 w-14 h-14 rounded-full bg-slate-900 text-white shadow-lg hover:bg-slate-800 flex items-center justify-center" title="Ask ReportAL" aria-label="Ask ReportAL"><Sparkles className="w-6 h-6" /></button></DialogTrigger>
      <DialogContent className="max-w-xl">
        <DialogHeader><DialogTitle>Ask ReportAL</DialogTitle><DialogDescription>Answers are grounded in your authorised school data.</DialogDescription></DialogHeader>
