...
export default function BulkStaffUpload({ callerCreds, school, onImported }) {
  ...
  return <SectionCard title="Bulk Add Staff" subtitle="Upload a CSV to create multiple teacher or school manager accounts" icon={Upload}>
    <div className="space-y-3">
      <p className="text-xs text-slate-500">Use columns: <span className="font-mono">full_name,email,role,username,password,subject,room</span>. Separate multiple subjects with a semicolon (for example, <span className="font-mono">Math;Science</span>). Role is optional and defaults to teacher.</p>
