...
export default function SchoolAccessManager({ callerCreds, adminUser }) {
  const [schools, setSchools] = useState([]); const [query, setQuery] = useState(""); const [schoolKey, setSchoolKey] = useState(""); const [reason, setReason] = useState(""); const [error, setError] = useState(""); const [saving, setSaving] = useState(false);
