...
import LoginRecoveryDialog from "@/components/login/LoginRecoveryDialog";
...
const SCENES = [
  ...
  { time: "morning", url: "https://media.base44.com/images/public/6a71ff59da728c2aa6a0d50b/93fb89661_generated_image.png", title: "Monte Sano State Park", location: "Huntsville, Alabama", fact: "Monte Sano, meaning ‘Mountain of Health,’ offers scenic overlooks and more than 20 miles of hiking trails above Huntsville." },
  { time: "afternoon", url: "https://media.base44.com/images/public/6a71ff59da728c2aa6a0d50b/c31c28eab_generated_image.png", title: "Oak Mountain State Park", location: "Pelham, Alabama", fact: "At nearly 10,000 acres, Oak Mountain is Alabama’s largest state park, with trails, lakes and forested ridges." },
  { time: "evening", url: "https://media.base44.com/images/public/6a71ff59da728c2aa6a0d50b/b4fef522b_generated_image.png", title: "DeSoto State Park", location: "Fort Payne, Alabama", fact: "Set atop Lookout Mountain, DeSoto State Park is known for waterfalls, wildflowers and rugged canyon scenery." },
  { time: "afternoon", url: "https://media.base44.com/images/public/6a71ff59da728c2aa6a0d50b/8d91f6fdc_generated_image.png", title: "Rickwood Caverns State Park", location: "Warrior, Alabama", fact: "Rickwood Caverns reveals ancient underground chambers shaped by water over millions of years, with a rare cave ecosystem." },
  { time: "morning", url: "https://images.unsplash.com/photo-1675737220508-6ddad0f837fd?auto=format&fit=crop&w=1920&q=80", title: "Auburn University", location: "Auburn, Alabama", fact: "Founded in 1856, Auburn is renowned for engineering, agriculture, business and veterinary medicine — and for its legendary Tigers and Iron Bowl rivalry with Alabama." },
  { time: "morning", url: "https://media.base44.com/images/public/6a71ff59da728c2aa6a0d50b/79e0d87a1_generated_image.png", title: "University of Alabama", location: "Tuscaloosa, Alabama", fact: "Founded in 1831, Alabama's flagship university is known for law, business, engineering and research, alongside the championship tradition of the Crimson Tide." },
  { time: "afternoon", url: "https://media.base44.com/images/public/6a71ff59da728c2aa6a0d50b/b37d25fa0_image.png", title: "University of Alabama at Birmingham", location: "Birmingham, Alabama", fact: "Established as an independent university in 1969, UAB is a leading academic medical center renowned for medicine, healthcare and biomedical research in Birmingham." },
  { time: "afternoon", url: "https://media.base44.com/images/public/6a71ff59da728c2aa6a0d50b/ea16271d5_image.png", title: "University of Alabama at Huntsville", location: "Huntsville, Alabama", fact: "Founded in 1950, UAH is a research-intensive university specialising in aerospace, engineering, computer science and space science at the heart of Huntsville's Rocket City." },
  { time: "evening", url: "https://media.base44.com/images/public/6a71ff59da728c2aa6a0d50b/adb852887_image.png", title: "Jacksonville State University", location: "Jacksonville, Alabama", fact: "Founded in 1883, Jax State is a comprehensive university with strong traditions in education, nursing and student success — and home to the Gamecocks." },
];
...
export default function SelectSchool() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Administrators enter the platform portal through the standard sign-in flow.
      if (user.role === "admin") {
