...
export default function SeatingPlan() {
  ...
  const savePlan = async () => {
    if (!classInfo) return;
    setSaving(true);
    const payload = { class_id: classId, school_code: classInfo.school_code, name: "Current seating plan", columns, seats };
