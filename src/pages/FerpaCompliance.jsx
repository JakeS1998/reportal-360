...
const SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Report and student record access logged", status: "done" },
      { label: "Export/download actions logged", status: "done" },
              { label: "Suspicious activity alerts", status: "done" },
      { label: "Audit log retention policy", status: "done" },
    ],
  },
  {
    title: "Data Security",
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Export actions logged", status: "done" },
      { label: "Large exports monitored", status: "done" },
    ],
  },
  {
    ...
    items: [
      ...
      { label: "Data sharing agreements", status: "done" },
      { label: "Vendor security reviews", status: "done" },
      { label: "API access logged", status: "done" },
  ...
  },
  {
    ...
    icon: FileCheck,
    items: [
      { label: "FERPA responsibilities assigned", status: "done" },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Secure session management (8h expiry + 30m idle timeout)", status: "done" },
      ...
      { label: "Regular penetration testing (automated security scanner)", status: "done" },
    ],
  },
];
